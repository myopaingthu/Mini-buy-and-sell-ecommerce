                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('products.update', [$id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            <label for="name" class="col-md-4 col-form-label text-md-right">{{ __('Name') }}</label>
                            <div class="col-md-6">
                                <input type="text" class="form-control" name="status" value="{{$edited_product['available'] == 0 ? 'Sold out' : 'Available'}}" readonly>
                                <input type="hidden" class="form-control" name="available" value="{{$edited_product['available']}}">
                            </div>
                        </div>
